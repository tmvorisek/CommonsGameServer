...
CREATE TABLE IF NOT EXISTS summit (
	id SERIAL UNIQUE NOT NULL PRIMARY KEY,
	commons_index REAL NOT NULL DEFAULT 0,
	game_id INT NOT NULL REFERENCES game(id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS player (
    id SERIAL UNIQUE NOT NULL PRIMARY KEY,
    summit_id INT NOT NULL REFERENCES summit(id) ON DELETE CASCADE DEFAULT 0,
    name VARCHAR(16),
...
CREATE TABLE IF NOT EXISTS chat (
    ...
    summit_id INT NOT NULL REFERENCES summit(id) ON DELETE CASCADE
);
